          ...
          <div className="flex items-start gap-4">
            <div className="flex-1">
              ...
              <DialogDescription className="text-lg">
                {university.fullName || university.name} • {program.faculty || "Faculty"}
              </DialogDescription>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-700 leading-relaxed">
                    {program.description || "Detailed program description not available."}
                  </p>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      ...
                      <span className="text-book-600">{program.duration || "Not specified"}</span>
                    </div>
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      <span className="font-medium">Faculty</span>
                      <span className="text-book-600">{program.faculty || "Not specified"}</span>
                    </div>
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                ...
                <CardContent>
                  <div className="grid gap-4">
                    {(program.careerProspects && program.careerProspects.length > 0) ? (
                      ...
                      <p className="text-gray-600">Career prospects information not available.</p>
                    )}
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-orange-50 rounded-lg">
                      ...
                      <Badge className="bg-orange-100 text-orange-700 text-lg">
                        {program.apsRequirement > 100 ? Math.round(program.apsRequirement / 10) : program.apsRequirement}
                      </Badge>
                    </div>
                    <div>
