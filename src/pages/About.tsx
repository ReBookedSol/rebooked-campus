...
const About = () => {
  useSEO({
    title: "About — Student Accommodation Platform",
    description: "ReBooked Living helps South African students find safe, NSFAS-accredited housing near their university. Verified listings, transparent pricing.",
    canonical: "/about",
  });
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-accent to-primary p-8 rounded-xl text-white shadow-md">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex gap-3">
                <Link to="/accommodation"><Button className="bg-white text-primary">Browse Listings</Button></Link>
